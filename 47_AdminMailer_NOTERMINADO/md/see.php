<div>
    <ul class="create">
        <li><a href=<?php echo $_SERVER['PHP_SELF'].'?it=admin&md=erase&tp=usuario'; ?>><button class="root">mensajes</button></a></li>
        <li><a href=<?php echo $_SERVER['PHP_SELF'].'?it=admin&md=erase&tp=lista'; ?>><button class="root">lista de usuarios</button></a></li>
    </ul>
</div>
<?php
if(isset($_GET['tp'])){
